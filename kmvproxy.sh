...
SERVER_REPO="git@gitlab.com:thebetelnutsoup/kmvproxy.git"
SRV_SRC_GO_PATH="gitlab.com/thebetelnutsoup/kmvproxy"
WEB_CLIENT_NAME="sparrow"
WEB_CLIENT_REPO="https://github.com/varunamachi/sparrow"
